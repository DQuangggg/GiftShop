<%-- 
    ...
    Created on : Apr 18, 2023, 8:42:08 PM
    Author     : ADMIN
--%>
...
<!--                        <form style="float: right;" action="managerAccount" method="get">
            ...
            <div class="row">    
                <div id="pagination">
                    <span class="prev"><a title="" href="managerAccount?index=${tag-1>0?tag-1:"1"}">« Previous</a></span>
                    <c:forEach begin="1" end="${endP}" var="i">
                        <span class=" ${i==tag?"current":""}"><a href="managerAccount?index=${i}">${i}</a></span>
                    </c:forEach>
                    <span class="next"><a title="" href="managerAccount?index=${tag+1>endP?endP:tag+1}">Next »</a></span>
                </div>
            </div>                                                                             
        </div>
        <div class="container-fluid ">
